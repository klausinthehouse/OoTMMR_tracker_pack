...
function _mm_logic()
	...
	function grandma_story_1()
		return before(DAY1_PM_04_00) or between(DAY2_AM_06_00, DAY2_PM_04_00) or (is_day1() and (clock_night1() or clock_day2() or clock_night2() or clock_day3() or clock_night3() or setting('moonCrash', 'cycle'))) or (is_day2() and (clock_night2() or clock_day3() or clock_night3() or setting('moonCrash', 'cycle')))
	end

	function grandma_story_2()
		return is_day1() and (clock_day2() or clock_night2() or clock_day3() or clock_night3() or setting('moonCrash', 'cycle')) or (is_day2() and (clock_day3() or clock_night3() or setting('moonCrash', 'cycle')))
	end
	...
	function is_spring()
		return flag_on(MM_REGION_NORTH_CLEARED) and flag_off(MM_REGION_NORTH_CURSED) and (setting('erBoss', 'none') and setting('regionState', 'dungeonBeaten') and event('BOSS_GOHT') or event('CLEAR_STATE_SNOWHEAD'))
	end
	...
	function is_swamp_cleared()
		return flag_on(MM_REGION_SWAMP_CLEARED) and flag_off(MM_REGION_SWAMP_CURSED) and (setting('erBoss', 'none') and setting('regionState', 'dungeonBeaten') and event('BOSS_ODOLWA') or event('CLEAR_STATE_WOODFALL'))
	end
	...
	function is_ocean_cleared()
		return flag_on(MM_REGION_OCEAN_CLEARED) and flag_off(MM_REGION_OCEAN_CURSED) and (setting('erBoss', 'none') and setting('regionState', 'dungeonBeaten') and event('BOSS_GYORG') or event('CLEAR_STATE_GREAT_BAY'))
	end
	...
	function is_valley_cleared()
		return flag_on(MM_REGION_VALLEY_CLEARED) and flag_off(MM_REGION_VALLEY_CURSED) and (setting('erBoss', 'none') and setting('regionState', 'dungeonBeaten') and event('BOSS_TWINMOLD') or event('CLEAR_STATE_IKANA'))
	end
	...
	function OLD_hot_water(winter, spring)
		return has_bottle() and (event(winter) and event(spring) or (is_winter() and event(winter)) or (is_spring() and event(spring)))
	end

	function hot_water(x)
		return has_bottle() and event(x)
	end

	function hot_water_winter(x)
		return is_winter() and hot_water(x)
	end

	function hot_water_spring(x)
		return is_spring() and hot_water(x)
	end

	function has_hot_water_mtn()
		return hot_water_winter(HOT_WATER_NORTH_WINTER) or hot_water_spring(HOT_WATER_NORTH_SPRING) or (hot_water(HOT_WATER_NORTH_WINTER) and hot_water(HOT_WATER_NORTH_SPRING))
	end

	function has_hot_water_well()
		return hot_water_winter(HOT_WATER_WELL_WINTER) or hot_water_spring(HOT_WATER_WELL_SPRING) or (hot_water(HOT_WATER_WELL_WINTER) and hot_water(HOT_WATER_WELL_SPRING))
	end

	function has_hot_water_any()
		return has_hot_water_mtn() or has_hot_water_well() or ((hot_water(HOT_WATER_NORTH_WINTER) or hot_water(HOT_WATER_WELL_WINTER)) and (hot_water(HOT_WATER_NORTH_SPRING) or hot_water(HOT_WATER_WELL_SPRING)))
	end

	function has_hot_water_distance()
		return (can_play_soaring() or can_use_farore()) and has_hot_water_any()
	end

	function has_hot_water_er()
		return er_enabled() and has_hot_water_any()
	end

	function has_hot_water_farore()
		return can_use_farore() and has_hot_water_any()
	end
    ...
    ["Beneath The Well North Section"] = {
        ...
        ["exits"] = {
            ["Beneath The Well Hot Spring Water"] = function () return setting('beneathWell', 'open') or (can_pass_gibdo() and has_fish()) end,
            ["Beneath The Well Near Fountain"] = function () return setting('beneathWell', 'open') or (can_pass_gibdo() and has_water()) end,
        },
        ["age_change"] = false,
    },
    ["Beneath The Well Hot Spring Water"] = {
        ["events"] = {
            ["HOT_WATER_WELL_SPRING"] = function () return is_spring() and (has_explosives() or has_mask_zora() or trick_keg_explosives() or trick('MM_WELL_HSW')) end,
            ["HOT_WATER_WELL_WINTER"] = function () return is_winter() and (has_explosives() or has_mask_zora() or trick_keg_explosives() or trick('MM_WELL_HSW')) end,
            ["FISH"] = function () return true end,
            ["WATER"] = function () return true end,
        },
        ["exits"] = {
            ["Beneath The Well North Section"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ["Beneath The Well Near Fountain"] = {
        ["events"] = {
            ["BUGS"] = function () return has_fire_sticks() end,
            ["BOMBS_OR_BOMBCHU"] = function () return has_fire_sticks() end,
            ["RUPEES"] = function () return (can_fight() or has_weapon_range() or has_explosives()) and soul_wallmaster() end,
        },
        ["exits"] = {
            ["Beneath The Well North Section"] = function () return true end,
            ["Beneath The Well Wallmaster Near Fountain"] = function () return soul_wallmaster() end,
            ["Beneath The Well Fairy Fountain"] = function () return setting('beneathWell', 'open') or (can_pass_gibdo() and has_bugs()) end,
            ["Beneath The Well Keese"] = function () return setting('beneathWell', 'open') or (can_pass_gibdo() and has_bugs()) end,
        },
        ["locations"] = {
            ["Beneath The Well Pot Left Side 1"] = function () return has_fire_sticks() end,
            ["Beneath The Well Pot Left Side 2"] = function () return has_fire_sticks() end,
            ["Beneath The Well Pot Left Side 3"] = function () return has_fire_sticks() end,
            ["Beneath The Well Pot Left Side 4"] = function () return has_fire_sticks() end,
            ["Beneath The Well Pot Left Side 5"] = function () return has_fire_sticks() end,
            ["Beneath The Well Grass Left Side 1"] = function () return has_fire_sticks() end,
            ["Beneath The Well Grass Left Side 2"] = function () return has_fire_sticks() end,
        },
        ["age_change"] = false,
    },
    ["Beneath The Well Fairy Fountain"] = {
        ...
        ["exits"] = {
            ["Beneath The Well Near Fountain"] = function () return true end,
        },
        ["locations"] = {
            ["Beneath The Well Fairy Fountain Fairy 1"] = function () return true end,
            ["Beneath The Well Fairy Fountain Fairy 2"] = function () return true end,
            ["Beneath The Well Fairy Fountain Fairy 3"] = function () return true end,
            ["Beneath The Well Fairy Fountain Fairy 4"] = function () return true end,
            ["Beneath The Well Fairy Fountain Fairy 5"] = function () return true end,
            ["Beneath The Well Fairy Fountain Fairy 6"] = function () return true end,
            ["Beneath The Well Fairy Fountain Fairy 7"] = function () return true end,
            ["Beneath The Well Fairy Fountain Fairy 8"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ["Beneath The Well Keese"] = {
        ["events"] = {
            ["RUPEES"] = function () return soul_keese() and can_use_light_arrows() end,
        },
        ["exits"] = {
            ["Beneath The Well Near Fountain"] = function () return true end,
        },
    ...
    ["Beneath The Well East Section"] = {
        ...
        ["exits"] = {
            ...
            ["Beneath The Well Middle Section"] = function () return setting('beneathWell', 'open') or (can_pass_gibdo() and has_fish()) end,
            ["Beneath The Well Cow Hall"] = function () return setting('beneathWell', 'open') or (can_pass_gibdo() and has_nuts()) end,
        },
        ["age_change"] = false,
    },
    ["Beneath The Well Cow Hall"] = {
        ...
        ["exits"] = {
            ...
            ["Beneath The Well Cow Room"] = function () return setting('beneathWell', 'open') or (can_pass_gibdo() and (has_hot_water_well() or (has_hot_water_distance() and has('OWL_IKANA_CANYON')) or has_hot_water_er())) end,
            ["Beneath The Well Big Poe Room"] = function () return setting('beneathWell', 'open') or (can_pass_gibdo() and has_bombs()) end,
        },
        ["locations"] = {
    ...
    ["Beneath The Well Big Poe Room"] = {
        ...
        ["locations"] = {
            ["Beneath The Well Pot Big Poe 1"] = function () return true end,
            ["Beneath The Well Pot Big Poe 2"] = function () return true end,
            ["Beneath The Well Pot Big Poe 3"] = function () return true end,
            ["Beneath The Well Pot Big Poe 4"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ["Beneath The Well Middle Section"] = {
        ...
        ["exits"] = {
            ["Beneath The Well East Section"] = function () return true end,
            ["Beneath The Well Final Hall"] = function () return setting('beneathWell', 'open') or (can_pass_gibdo() and has_big_poe()) end,
            ["Beneath The Well Skulltulla Room"] = function () return setting('beneathWell', 'open') or (can_pass_gibdo() and has_bugs()) end,
        },
        ["locations"] = {
    ...
    ["Beneath The Well Skulltulla Room"] = {
        ...
        ["locations"] = {
            ["Beneath The Well Skulltulla Chest"] = function () return has_fire_sticks() end,
        },
        ["age_change"] = false,
    },
    ["Beneath The Well Final Hall"] = {
        ["events"] = {
            ["RUPEES"] = function () return (can_fight() or has_weapon_range() or has_explosives()) and soul_wallmaster() end,
            ["BUGS"] = function () return can_use_fire_short_range() or (has_sticks() and (setting('beneathWell', 'open') or (has_big_poe() and can_pass_gibdo()))) end,
        },
        ["exits"] = {
            ["Beneath The Well Wallmaster Near Exit"] = function () return soul_wallmaster() end,
            ["Beneath The Well Middle Section"] = function () return true end,
            ["Beneath The Well Sun Block"] = function () return setting('beneathWell', 'open') or (can_pass_gibdo() and has_milk()) end,
        },
        ["locations"] = {
            ["Beneath The Well Grass Near End 1"] = function () return can_use_fire_short_range() or (has_sticks() and (setting('beneathWell', 'open') or (has_big_poe() and can_pass_gibdo()))) end,
            ["Beneath The Well Grass Near End 2"] = function () return can_use_fire_short_range() or (has_sticks() and (setting('beneathWell', 'open') or (has_big_poe() and can_pass_gibdo()))) end,
            ["Beneath The Well Grass Near End 3"] = function () return can_use_fire_short_range() or (has_sticks() and (setting('beneathWell', 'open') or (has_big_poe() and can_pass_gibdo()))) end,
            ["Beneath The Well Grass Near End 4"] = function () return can_use_fire_short_range() or (has_sticks() and (setting('beneathWell', 'open') or (has_big_poe() and can_pass_gibdo()))) end,
            ["Beneath The Well Grass Near End 5"] = function () return can_use_fire_short_range() or (has_sticks() and (setting('beneathWell', 'open') or (has_big_poe() and can_pass_gibdo()))) end,
        },
        ["age_change"] = false,
    },
    ["Beneath The Well Sun Block"] = {
        ["exits"] = {
            ...
            ["Beneath The Well End"] = function () return setting('beneathWell', 'open') or has_mirror_shield() or can_use_light_arrows() end,
        },
        ["locations"] = {
            ["Beneath The Well Mirror Shield"] = function () return can_use_fire_short_range() or (has_sticks() and (setting('beneathWell', 'open') or (has_big_poe() and has_milk() and can_pass_gibdo()))) end,
        },
        ["age_change"] = false,
    },
    ...
    ["Great Bay Temple Entrance"] = {
        ...
        ["locations"] = {
            ...
            ["Great Bay Temple Barrel Entrance 1"] = function () return true end,
            ["Great Bay Temple Barrel Entrance 2"] = function () return true end,
            ["Great Bay Temple Barrel Entrance 3"] = function () return true end,
            ["Great Bay Temple Barrel Entrance 4"] = function () return true end,
            ["Great Bay Temple Barrel Entrance 5"] = function () return true end,
    ...
    ["Great Bay Temple Red Pipe 2"] = {
        ...
        ["locations"] = {
            ["Great Bay Temple Crate Chu Room 1"] = function () return true end,
            ["Great Bay Temple Crate Chu Room 2"] = function () return true end,
            ["Great Bay Temple Crate Chu Room 3"] = function () return true end,
            ["Great Bay Temple Crate Chu Room 4"] = function () return true end,
            ["Great Bay Temple Crate Chu Room 5"] = function () return true end,
            ["Great Bay Temple Barrel Chu Room 1"] = function () return true end,
            ["Great Bay Temple Barrel Chu Room 2"] = function () return true end,
            ["Great Bay Temple Barrel Chu Room 3"] = function () return true end,
            ["Great Bay Temple Barrel Chu Room 4"] = function () return true end,
            ["Great Bay Temple Barrel Chu Room 5"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ["Great Bay Temple Boss Key Room"] = {
        ...
        ["locations"] = {
            ["Great Bay Temple Crate Before Boss Key 01"] = function () return true end,
            ["Great Bay Temple Crate Before Boss Key 02"] = function () return true end,
            ["Great Bay Temple Crate Before Boss Key 03"] = function () return true end,
            ["Great Bay Temple Crate Before Boss Key 04"] = function () return true end,
            ["Great Bay Temple Crate Before Boss Key 05"] = function () return true end,
            ["Great Bay Temple Crate Before Boss Key 06"] = function () return true end,
            ["Great Bay Temple Crate Before Boss Key 07"] = function () return true end,
            ["Great Bay Temple Crate Before Boss Key 08"] = function () return true end,
            ["Great Bay Temple Crate Before Boss Key 09"] = function () return true end,
            ["Great Bay Temple Crate Before Boss Key 10"] = function () return true end,
            ["Great Bay Temple Crate Before Boss Key 11"] = function () return true end,
            ["Great Bay Temple Crate Before Boss Key 12"] = function () return true end,
            ["Great Bay Temple Crate Before Boss Key 13"] = function () return true end,
            ["Great Bay Temple Crate Before Boss Key 14"] = function () return true end,
            ["Great Bay Temple Crate Before Boss Key 15"] = function () return true end,
            ["Great Bay Temple Crate Before Boss Key 16"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ...
    ["Great Bay Temple Green Pipe 1"] = {
        ...
        ["locations"] = {
            ...
            ["Great Bay Temple Barrel Green Pipe 1 1"] = function () return can_use_ice_arrows() end,
            ["Great Bay Temple Barrel Green Pipe 1 2"] = function () return can_use_ice_arrows() end,
            ["Great Bay Temple Barrel Green Pipe 1 3"] = function () return can_use_ice_arrows() end,
    ...
    ["Great Bay Temple Green Pipe 2"] = {
        ...
        ["locations"] = {
            ...
            ["Great Bay Temple Barrel Green Pipe 2 1"] = function () return true end,
            ["Great Bay Temple Barrel Green Pipe 2 2"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ["Great Bay Temple Green Pipe 3"] = {
        ...
        ["locations"] = {
            ...
            ["Great Bay Temple Crate Green Pipe 1"] = function () return true end,
            ["Great Bay Temple Crate Green Pipe 2"] = function () return true end,
            ["Great Bay Temple Crate Green Pipe 3"] = function () return true end,
            ["Great Bay Temple Crate Green Pipe 4"] = function () return true end,
            ["Great Bay Temple Crate Green Pipe 5"] = function () return true end,
            ["Great Bay Temple Crate Green Pipe 6"] = function () return true end,
            ["Great Bay Temple Crate Green Pipe 7"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ...
    ["Great Bay Temple Boss"] = {
        ["events"] = {
            ["BOSS_GYORG"] = function () return soul_boss(SOUL_BOSS_GYORG) and (has_magic() and (has_mask_zora() and has_arrows() or has('MASK_FIERCE_DEITY')) or (has_iron_boots() and has_tunic_zora_strict() and can_hookshot_short() and trick('MM_GYORG_IRONS'))) end,
        },
        ["exits"] = {
    ...
    ["Clock Tower Roof"] = {
        ["events"] = {
            ["MAGIC"] = function () return true end,
            ["MM_MOON_OPEN"] = function () return (can_play_order() or setting('openMoon')) and special(MOON) end,
        },
        ["exits"] = {
            ["Moon"] = function () return event('MM_MOON_OPEN') end,
            ["Clock Tower Platform"] = function () return false end,
        },
        ["locations"] = {
            ["Clock Tower Roof Skull Kid Ocarina"] = function () return cond(setting('shufflePotsMm', 'none'), has('MASK_DEKU') and (has('MAGIC_UPGRADE') or has('SHARED_MAGIC_UPGRADE')) or has_weapon_range(), has_weapon_range()) and (can_play_time() or event('MAJORA') or (setting('erMoon') and dungeon_er()) or setting('moonCrash', 'cycle')) end,
            ["Clock Tower Roof Skull Kid Song of Time"] = function () return cond(setting('shufflePotsMm', 'none'), has('MASK_DEKU') and (has('MAGIC_UPGRADE') or has('SHARED_MAGIC_UPGRADE')) or has_weapon_range(), has_weapon_range()) and (can_play_time() or event('MAJORA') or (setting('erMoon') and dungeon_er()) or setting('moonCrash', 'cycle')) end,
    ...
    ["Ocean Spider House Back"] = {
        ["locations"] = {
            ...
            ["Ocean Spider House Crate"] = function () return has_fire_sticks() end,
    ...
    ["ACCESS"] = {
        ["events"] = {
            ["ACCESS"] = function () return can_reset_time_impl() end,
        },
        ["age_change"] = false,
    },
    ["WARP_SONGS"] = {
    ...
    ["Owl Snowhead"] = {
        ...
        ["locations"] = {
            ...
            ["Snowhead Small Snowball 4"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ["Owl Great Bay"] = {
    ...
    ["Laundry Pool"] = {
        ...
        ["locations"] = {
            ...
            ["Clock Town Laundry Pool Small Crate"] = function () return true end,
    ...
    ["Scrub Grotto"] = {
        ...
        ["locations"] = {
            ...
            ["Termina Field Scrub Crate"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ...
    ["Road to Southern Swamp"] = {
        ...
        ["locations"] = {
            ...
            ["Road to Southern Swamp Potted Plant 1 Pot"] = function () return true end,
    ...
    ["Deku Palace Main"] = {
        ...
        ["locations"] = {
            ...
            ["Deku Palace Rupee Left 1"] = function () return true end,
            ["Deku Palace Rupee Left 2"] = function () return true end,
            ["Deku Palace Rupee Left 3"] = function () return true end,
            ["Deku Palace Rupee Left 5"] = function () return true end,
            ["Deku Palace Rupee Left 6"] = function () return true end,
            ["Deku Palace Rupee Left 7"] = function () return true end,
    ...
    ["Mountain Village Path Lower"] = {
        ...
        ["locations"] = {
            ["Path to Mountain Village Big Snowball Lower 1"] = function () return is_winter() and can_break_snowballs() end,
            ["Path to Mountain Village Big Snowball Lower 2"] = function () return is_winter() and can_break_snowballs() end,
            ["Path to Mountain Village Big Snowball Lower 3"] = function () return is_winter() and can_break_snowballs() end,
            ["Path to Mountain Village Big Snowball Lower 4"] = function () return is_winter() and can_break_snowballs() end,
            ["Path to Mountain Village Big Snowball Middle 1"] = function () return is_winter() and can_break_snowballs() end,
            ["Path to Mountain Village Big Snowball Middle 2"] = function () return is_winter() and can_break_snowballs() end,
            ["Path to Mountain Village Big Snowball Middle 3"] = function () return is_winter() and can_break_snowballs() end,
            ["Path to Mountain Village Big Snowball Middle 4"] = function () return is_winter() and can_break_snowballs() end,
            ["Path to Mountain Village Small Snowball Lower Winter 1"] = function () return is_winter() end,
            ["Path to Mountain Village Small Snowball Lower Winter 2"] = function () return is_winter() end,
            ["Path to Mountain Village Small Snowball Lower Winter 3"] = function () return is_winter() end,
            ["Path to Mountain Village Small Snowball Lower Spring 1"] = function () return is_spring() end,
    ...
    ["Mountain Village Path Upper"] = {
        ...
        ["locations"] = {
            ...
            ["Path to Mountain Village Big Snowball Middle 3"] = function () return is_winter() and can_break_snowballs() end,
            ["Path to Mountain Village Big Snowball Middle 4"] = function () return is_winter() and can_break_snowballs() end,
            ["Path to Mountain Village Big Snowball Upper 1"] = function () return is_winter() and can_break_snowballs() end,
            ["Path to Mountain Village Big Snowball Upper 2"] = function () return is_winter() and can_break_snowballs() end,
            ["Path to Mountain Village Big Snowball Upper 3"] = function () return is_winter() and can_break_snowballs() end,
            ["Path to Mountain Village Small Snowball Upper Winter"] = function () return is_winter() end,
    ...
    ["Mountain Village"] = {
        ...
        ["locations"] = {
            ...
            ["Mountain Village Potted Plant 2 Pot"] = function () return is_day() end,
            ["Mountain Village Potted Plant 2 Grass"] = function () return is_day() end,
            ["Mountain Village Big Snowball 1"] = function () return is_winter() and can_break_snowballs() end,
            ["Mountain Village Big Snowball 2"] = function () return is_winter() and can_break_snowballs() end,
            ["Mountain Village Big Snowball 3"] = function () return (first_day() or second_day()) and is_winter() and can_break_snowballs() end,
            ["Mountain Village Big Snowball 4"] = function () return is_winter() and can_break_snowballs() end,
            ["Mountain Village Big Snowball 5"] = function () return is_winter() and can_break_snowballs() end,
            ["Mountain Village Small Snowball 1"] = function () return true end,
            ["Mountain Village Small Snowball 2"] = function () return true end,
            ["Mountain Village Small Snowball 3"] = function () return true end,
            ["Mountain Village Small Snowball 4"] = function () return true end,
            ["Mountain Village Small Snowball 5"] = function () return true end,
            ["Mountain Village Small Snowball Winter 1"] = function () return is_winter() end,
    ...
    ["Blacksmith"] = {
        ...
        ["locations"] = {
            ...
            ["Blacksmith Potted Plant 1 Pot"] = function () return is_night() end,
    ...
    ["Twin Islands"] = {
        ...
        ["locations"] = {
            ...
            ["Twin Islands Big Snowball 01"] = function () return (first_day() or final_day()) and is_winter() and can_break_snowballs() end,
            ["Twin Islands Big Snowball 02"] = function () return is_winter() and can_break_snowballs() end,
            ["Twin Islands Big Snowball 03"] = function () return is_winter() and can_break_snowballs() end,
            ["Twin Islands Big Snowball 04"] = function () return is_winter() and can_break_snowballs() end,
            ["Twin Islands Big Snowball 05"] = function () return is_winter() and can_break_snowballs() end,
            ["Twin Islands Big Snowball 06"] = function () return is_winter() and can_break_snowballs() end,
            ["Twin Islands Big Snowball 07"] = function () return is_winter() and can_break_snowballs() end,
            ["Twin Islands Big Snowball 08"] = function () return (second_day() or final_day()) and is_winter() and can_break_snowballs() end,
            ["Twin Islands Big Snowball 09"] = function () return is_winter() and can_break_snowballs() end,
            ["Twin Islands Big Snowball 10"] = function () return is_winter() and can_break_snowballs() end,
            ["Twin Islands Big Snowball 11"] = function () return is_winter() and can_break_snowballs() end,
            ["Twin Islands Big Snowball 12"] = function () return is_winter() and can_break_snowballs() end,
            ["Twin Islands Big Snowball 13"] = function () return (first_day() or final_day()) and is_winter() and can_break_snowballs() end,
    ...
    ["Near Ramp Grotto"] = {
        ...
        ["locations"] = {
            ...
            ["Twin Islands Small Snowball Ramp 2"] = function () return is_winter() end,
            ["Twin Islands Small Snowball Ramp 3"] = function () return is_winter() end,
        },
        ["age_change"] = false,
    },
    ["Goron Village"] = {
        ...
        ["locations"] = {
            ...
            ["Goron Village Crate"] = function () return is_spring() or can_use_fire_short_range() or (short_hook_anywhere() and trick('MM_KEG_TRIAL_HEATLESS')) end,
            ["Goron Village Big Snowball 1"] = function () return is_winter() and can_break_snowballs() end,
            ["Goron Village Big Snowball 2"] = function () return is_winter() and can_break_snowballs() end,
            ["Goron Village Big Snowball 3"] = function () return is_winter() and can_break_snowballs() end,
            ["Goron Village Big Snowball 4"] = function () return is_winter() and can_break_snowballs() end,
            ["Goron Village Big Snowball 5"] = function () return is_winter() and can_break_snowballs() end,
            ["Goron Village Big Snowball 6"] = function () return is_winter() and can_break_snowballs() end,
            ["Goron Village Big Snowball 7"] = function () return is_winter() and can_break_snowballs() end,
            ["Goron Village Big Snowball 8"] = function () return is_winter() and can_break_snowballs() end,
            ["Goron Village Big Snowball 9"] = function () return is_winter() and can_break_snowballs() end,
            ["Goron Village Small Snowball 01"] = function () return is_winter() end,
            ["Goron Village Small Snowball 02"] = function () return is_winter() end,
            ["Goron Village Small Snowball 03"] = function () return is_winter() end,
            ["Goron Village Small Snowball 04"] = function () return is_winter() end,
            ["Goron Village Small Snowball 05"] = function () return is_winter() end,
            ["Goron Village Small Snowball 06"] = function () return is_winter() end,
            ["Goron Village Small Snowball 07"] = function () return is_winter() end,
            ["Goron Village Small Snowball 08"] = function () return is_winter() end,
            ["Goron Village Small Snowball 09"] = function () return is_winter() end,
    ...
    ["Mountain Village Cliff"] = {
        ...
        ["locations"] = {
            ["Mountain Village Small Snowball Cliff 1"] = function () return is_winter() end,
            ["Mountain Village Small Snowball Cliff 2"] = function () return is_winter() end,
        },
        ["age_change"] = false,
    },
    ...
    ["Path to Snowhead Middle"] = {
        ...
        ["locations"] = {
            ...
            ["Path to Snowhead Big Snowball Middle 1"] = function () return is_winter() and can_break_snowballs() end,
            ["Path to Snowhead Big Snowball Middle 2"] = function () return is_winter() and can_break_snowballs() end,
            ["Path to Snowhead Small Snowball Spring Middle 1"] = function () return is_spring() end,
            ["Path to Snowhead Small Snowball Spring Middle 2"] = function () return is_spring() end,
        },
        ["age_change"] = false,
    },
    ["Path to Snowhead Back"] = {
        ...
        ["locations"] = {
            ...
            ["Path to Snowhead Big Snowball Back 2"] = function () return is_winter() and can_break_snowballs() end,
            ["Path to Snowhead Small Snowball Back 1"] = function () return true end,
            ["Path to Snowhead Small Snowball Back 2"] = function () return true end,
    ...
    ["Snowhead Near Fairy Fountain"] = {
        ["events"] = {
            ["MAGIC"] = function () return (blizzard_stopped() or has_iron_boots()) and can_break_snowballs() or is_spring() end,
        ...
        ["locations"] = {
            ...
            ["Snowhead Big Snowball 4"] = function () return (blizzard_stopped() or has_iron_boots()) and is_winter() and can_break_snowballs() end,
            ["Snowhead Big Snowball 5"] = function () return (blizzard_stopped() or has_iron_boots()) and is_winter() and can_break_snowballs() end,
            ["Snowhead Big Snowball 6"] = function () return (blizzard_stopped() or has_iron_boots()) and is_winter() and can_break_snowballs() end,
            ["Snowhead Small Snowball Spring 1"] = function () return is_spring() end,
            ["Snowhead Small Snowball Spring 2"] = function () return is_spring() end,
            ["Snowhead Small Snowball Spring 3"] = function () return is_spring() end,
            ["Snowhead Small Snowball Spring 4"] = function () return is_spring() end,
            ["Snowhead Small Snowball Spring 5"] = function () return is_spring() end,
        },
        ["age_change"] = false,
    },
    ...
    ["Pirate Fortress Sewers Cage Room"] = {
        ...
        ["locations"] = {
            ...
            ["Pirate Fortress Sewers Barrel Cage Room 01"] = function () return true end,
            ["Pirate Fortress Sewers Barrel Cage Room 02"] = function () return true end,
            ["Pirate Fortress Sewers Barrel Cage Room 03"] = function () return true end,
            ["Pirate Fortress Sewers Barrel Cage Room 04"] = function () return true end,
            ["Pirate Fortress Sewers Barrel Cage Room 05"] = function () return true end,
            ["Pirate Fortress Sewers Barrel Cage Room 06"] = function () return true end,
            ["Pirate Fortress Sewers Barrel Cage Room 07"] = function () return true end,
            ["Pirate Fortress Sewers Barrel Cage Room 08"] = function () return true end,
            ["Pirate Fortress Sewers Barrel Cage Room 09"] = function () return true end,
            ["Pirate Fortress Sewers Barrel Cage Room 10"] = function () return true end,
            ["Pirate Fortress Sewers Barrel Cage Room 11"] = function () return true end,
            ["Pirate Fortress Sewers Barrel Cage Room 12"] = function () return true end,
            ["Pirate Fortress Sewers Barrel Cage Room 13"] = function () return true end,
            ["Pirate Fortress Sewers Barrel Cage Room 14"] = function () return true end,
            ["Pirate Fortress Sewers Barrel Cage Room 15"] = function () return true end,
            ["Pirate Fortress Sewers Barrel Cage Room 16"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ...
    ["Pirate Fortress Sewers End"] = {
        ...
        ["locations"] = {
            ...
            ["Pirate Fortress Sewers Barrel End 1"] = function () return true end,
            ["Pirate Fortress Sewers Barrel End 2"] = function () return true end,
            ["Pirate Fortress Sewers Barrel End 3"] = function () return true end,
            ["Pirate Fortress Sewers Barrel End 4"] = function () return true end,
            ["Pirate Fortress Sewers Barrel End 5"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ...
    ["Pirate Fortress Interior"] = {
        ...
        ["locations"] = {
            ...
            ["Pirate Fortress Interior Crate Entrance"] = function () return true end,
            ["Pirate Fortress Interior Crate Middle 1"] = function () return can_evade_gerudo() end,
            ["Pirate Fortress Interior Crate Middle 2"] = function () return can_evade_gerudo() end,
    ...
    ["Pirate Fortress Hookshot Room Lower"] = {
        ...
        ["locations"] = {
            ...
            ["Pirate Fortress Interior Barrel Hookshot Room 1"] = function () return event('FORTRESS_BEEHIVE') end,
            ["Pirate Fortress Interior Barrel Hookshot Room 2"] = function () return event('FORTRESS_BEEHIVE') end,
        },
        ["age_change"] = false,
    },
    ...
    ["Pirate Fortress Entrance Lookout"] = {
        ...
        ["locations"] = {
            ["Pirate Fortress Entrance Barrel"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ...
    ["Pirate Fortress Treasure Room Entry"] = {
        ...
        ["locations"] = {
            ["Pirate Fortress Interior Barrel Outside"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ...
    ["Pirate Fortress Treasure Room Aquarium"] = {
        ...
        ["locations"] = {
            ...
            ["Pirate Fortress Interior Barrel Aquarium"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ...
    ["Snowhead Temple Bridge Front"] = {
        ...
        ["locations"] = {
            ...
            ["Snowhead Temple Small Snowball Bridge Room 1"] = function () return true end,
            ["Snowhead Temple Small Snowball Bridge Room 2"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ["Snowhead Temple Bridge Back"] = {
        ...
        ["locations"] = {
            ...
            ["Snowhead Temple Crate Bridge"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ["Snowhead Temple Map Room"] = {
        ...
        ["locations"] = {
            ...
            ["Snowhead Temple Crate Map Room 1"] = function () return true end,
            ["Snowhead Temple Crate Map Room 2"] = function () return true end,
            ["Snowhead Temple Crate Map Room 3"] = function () return true end,
            ["Snowhead Temple Crate Map Room 4"] = function () return true end,
            ["Snowhead Temple Crate Map Room 5"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ...
    ["Snowhead Temple Center Level 1"] = {
        ["exits"] = {
            ...
            ["Snowhead Temple Pillars Room Upper"] = function () return can_use_fire_short_range() or trick_sht_hot_water() end,
    ...
    ["Snowhead Temple Pillars Room Upper"] = {
        ...
        ["exits"] = {
            ["Snowhead Temple Center Level 1"] = function () return true end,
            ["Snowhead Temple Pillars Room Lower"] = function () return true end,
            ["WARP_SONGS"] = function () return true end,
        },
        ["locations"] = {
    ...
    ["Snowhead Temple Pillars Room Lower"] = {
        ["exits"] = {
            ["Snowhead Temple Center Level 0"] = function () return true end,
            ["Snowhead Temple Pillars Room Upper"] = function () return (can_use_fire_short_range() or trick_sht_hot_water_er()) and has('MASK_DEKU') or short_hook_anywhere() or (soul_freezard() and can_hookshot() and trick('MM_SHT_PILLAR_ROOM_HOOKSHOT')) end,
        },
        ["locations"] = {
    ...
    ["Snowhead Temple Icicles"] = {
        ...
        ["locations"] = {
            ...
            ["Snowhead Temple Small Snowball Icicles Room 4"] = function () return true end,
            ["Snowhead Temple Small Snowball Icicles Room 5"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ...
    ["Snowhead Temple Dual Switches Unlocked"] = {
        ...
        ["locations"] = {
            ...
            ["Snowhead Temple Crate Dual Switches 1"] = function () return true end,
            ["Snowhead Temple Crate Dual Switches 2"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ...
    ["Snowhead Temple Center Level 3 Snow"] = {
        ...
        ["locations"] = {
            ...
            ["Snowhead Temple Small Snowball Central Room 1"] = function () return true end,
            ["Snowhead Temple Small Snowball Central Room 2"] = function () return true end,
            ["Snowhead Temple Small Snowball Central Room 3"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ["Snowhead Temple Center Level 3 Iced"] = {
        ...
        ["locations"] = {
            ["Snowhead Temple Central Room Alcove"] = function () return can_use_lens() end,
            ["Snowhead Temple Small Snowball Central Room 4"] = function () return true end,
            ["Snowhead Temple Small Snowball Central Room 5"] = function () return true end,
            ["Snowhead Temple Small Snowball Central Room 6"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ["Snowhead Temple Snow Room"] = {
        ...
        ["locations"] = {
            ...
            ["Snowhead Temple Small Snowball Snow Room 1"] = function () return true end,
            ["Snowhead Temple Small Snowball Snow Room 2"] = function () return true end,
            ["Snowhead Temple Small Snowball Snow Room 3"] = function () return true end,
            ["Snowhead Temple Small Snowball Snow Room 4"] = function () return true end,
            ["Snowhead Temple Small Snowball Snow Room 5"] = function () return true end,
    ...
    ["Snowhead Temple Center Level 4"] = {
        ...
        ["locations"] = {
            ["Snowhead Temple Big Snowball Central Room 1"] = function () return can_break_snowballs() end,
    ...
    ["Snowhead Temple Boss"] = {
        ["events"] = {
            ["MAGIC"] = function () return true end,
            ["ARROWS"] = function () return true end,
            ["BOSS_GOHT"] = function () return soul_boss(SOUL_BOSS_GOHT) and can_use_fire_short_range() end,
        },
        ["exits"] = {
    ...
    ["Stone Tower Temple Entrance"] = {
        ...
        ["locations"] = {
            ...
            ["Stone Tower Temple Crate Entrance 1"] = function () return true end,
            ["Stone Tower Temple Crate Entrance 2"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ["Stone Tower Temple West"] = {
        ...
        ["locations"] = {
            ["Stone Tower Temple Crate Maze Large 1"] = function () return has_explosives() or trick_keg_explosives() end,
            ["Stone Tower Temple Crate Maze Large 2"] = function () return has_explosives() or trick_keg_explosives() end,
            ["Stone Tower Temple Crate Maze Large 3"] = function () return has_explosives() or trick_keg_explosives() end,
            ["Stone Tower Temple Crate Maze Large 4"] = function () return has_explosives() or trick_keg_explosives() end,
            ["Stone Tower Temple Crate Maze Large 5"] = function () return has_explosives() or trick_keg_explosives() end,
            ["Stone Tower Temple Crate Maze Small 1"] = function () return has_explosives() or trick_keg_explosives() end,
            ["Stone Tower Temple Crate Maze Small 2"] = function () return has_explosives() or trick_keg_explosives() end,
        },
        ["age_change"] = false,
    },
    ...
    ["Stone Tower Temple Center Ledge"] = {
        ["exits"] = {
            ...
            ["Stone Tower Temple Center"] = function () return has_mask_zora() or soul_enemy(SOUL_ENEMY_DEXIHAND) or (has_tunic_zora() and has_iron_boots() and can_hookshot()) end,
            ["Stone Tower Temple Water Room"] = function () return underwater_walking() or can_dive_small() end,
            ["Stone Tower Temple Water Bridge"] = function () return can_goron_bomb_jump() and can_use_ice_arrows() or short_hook_anywhere() end,
            ["WARP_SONGS"] = function () return true end,
        },
        ["locations"] = {
            ["Stone Tower Temple Center Sun Block Chest"] = function () return short_hook_anywhere() or (can_use_light_arrows() and (can_goron_bomb_jump() and can_use_ice_arrows() or event('ST_WATER_CRYSTAL'))) end,
            ["Stone Tower Temple Rupee Center Room Left"] = function () return can_use_light_arrows() or short_hook_anywhere() end,
            ["Stone Tower Temple Rupee Center Room Right"] = function () return can_goron_bomb_jump() and can_use_ice_arrows() end,
        },
        ["age_change"] = false,
    },
    ["Stone Tower Temple Center"] = {
        ...
        ["locations"] = {
            ...
            ["Stone Tower Temple Crate Water 1"] = function () return true end,
            ["Stone Tower Temple Crate Water 2"] = function () return true end,
            ["Stone Tower Temple Crate Water 3"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ...
    ["Stone Tower Temple Wind Room"] = {
        ["exits"] = {
            ["Stone Tower Temple Light Arrow Room"] = function () return has('MASK_DEKU') or (not setting('jpLayouts', 'ST') and can_use_light_arrows()) or (short_hook_anywhere() and has_weapon() and trick('MM_ST_UPDRAFTS')) or hookshot_anywhere() end,
            ["WARP_SONGS"] = function () return true end,
        },
        ["locations"] = {
            ...
            ["Stone Tower Temple Wind Room Jail Chest"] = function () return (has('MASK_DEKU') or (not setting('jpLayouts', 'ST') and can_use_light_arrows()) or (short_hook_anywhere() and has_weapon() and trick('MM_ST_UPDRAFTS')) or hookshot_anywhere()) and (has_mask_goron() or (can_hammer() and has_iron_boots() and has_mask_bunny() and trick('MM_STT_LAVA_SWITCH_HAMMER'))) end,
            ["Stone Tower Temple Pot Wind Room 1"] = function () return has('MASK_DEKU') or (not setting('jpLayouts', 'ST') and can_use_light_arrows()) or (short_hook_anywhere() and has_weapon() and trick('MM_ST_UPDRAFTS')) or hookshot_anywhere() end,
            ["Stone Tower Temple Pot Wind Room 2"] = function () return has('MASK_DEKU') or (not setting('jpLayouts', 'ST') and can_use_light_arrows()) or (short_hook_anywhere() and has_weapon() and trick('MM_ST_UPDRAFTS')) or hookshot_anywhere() end,
            ["Stone Tower Temple Pot Wind Room 3"] = function () return has('MASK_DEKU') or (not setting('jpLayouts', 'ST') and can_use_light_arrows()) or (short_hook_anywhere() and has_weapon() and trick('MM_ST_UPDRAFTS')) or hookshot_anywhere() end,
            ["Stone Tower Temple Pot Wind Room 4"] = function () return has('MASK_DEKU') or (not setting('jpLayouts', 'ST') and can_use_light_arrows()) or (short_hook_anywhere() and has_weapon() and trick('MM_ST_UPDRAFTS')) or hookshot_anywhere() end,
    ...
    ["Stone Tower Temple Inverted Entrance"] = {
        ...
        ["locations"] = {
            ...
            ["Stone Tower Temple Inverted Crate Entrance Right 1"] = function () return true end,
            ["Stone Tower Temple Inverted Crate Entrance Right 2"] = function () return true end,
    ...
    ["Stone Tower Temple Inverted East Bridge"] = {
        ...
        ["exits"] = {
            ...
            ["Stone Tower Temple Inverted Gomess Corridor"] = function () return trick('MM_ISTT_EYEGORE') or short_hook_anywhere() or has_hover_boots() end,
            ["WARP_SONGS"] = function () return true end,
        },
        ["locations"] = {
    ...
    ["Stone Tower Temple Inverted Center"] = {
        ["exits"] = {
            ["Stone Tower Temple Inverted Gomess Corridor"] = function () return has('MASK_DEKU') and has_weapon_range() or hookshot_anywhere() end,
    ...
    ["Stone Tower Temple Inverted Gomess Corridor"] = {
        ...
        ["exits"] = {
            ...
            ["Stone Tower Temple Inverted Center Bridge"] = function () return trick('MM_ISTT_EYEGORE') and can_use_light_arrows() and can_hookshot() or hookshot_anywhere() end,
            ["Stone Tower Temple Inverted Boss Key Room"] = function () return true end,
            ["WARP_SONGS"] = function () return true end,
        },
        ["locations"] = {
            ["Stone Tower Temple Inverted Crate Before Gomess 1"] = function () return true end,
            ["Stone Tower Temple Inverted Crate Before Gomess 2"] = function () return true end,
            ["Stone Tower Temple Inverted Crate Before Gomess 3"] = function () return true end,
            ["Stone Tower Temple Inverted Crate Before Gomess 4"] = function () return true end,
            ["Stone Tower Temple Inverted Crate Before Gomess 5"] = function () return true end,
            ["Stone Tower Temple Inverted Crate Before Gomess 6"] = function () return true end,
        },
        ["age_change"] = false,
    },
    ...
    ["Stone Tower Temple Boss"] = {
        ["events"] = {
            ["BOSS_TWINMOLD"] = function () return soul_boss(SOUL_BOSS_TWINMOLD) and (has_arrows() and trick('MM_TWINMOLD_BOW') or (has_magic() and (has('MASK_GIANT') and has_sword() or has('MASK_FIERCE_DEITY')))) end,
        },
        ["exits"] = {
    ...
    ["Swamp Spider House Main"] = {
        ...
        ["locations"] = {
            ...
            ["Swamp Spider House Jar Rock"] = function () return true end,
            ["Swamp Spider House Crate Gold 1"] = function () return true end,
            ["Swamp Spider House Crate Gold 2"] = function () return true end,
            ["Swamp Spider House Crate Monument 1"] = function () return true end,
            ["Swamp Spider House Crate Monument 2"] = function () return true end,
            ["Swamp Spider House Crate Monument 3"] = function () return true end,
            ...
            ["Swamp Spider House Hive Tree Room 1"] = function () return break_hive() or has_bombchu() end,
            ["Swamp Spider House Hive Tree Room 2"] = function () return break_hive() or has_bombchu() end,
            ["Swamp Spider House Hive Tree Room 3"] = function () return break_hive() or has_bombchu() end,
        },
        ["age_change"] = false,
    },
    ["Woodfall Temple"] = {
    ...
    ["Woodfall Temple Maze"] = {
        ...
        ["locations"] = {
            ...
            ["Woodfall Temple Hive Maze"] = function () return break_hive() end,
        },
        ["age_change"] = false,
    },
    ...
    ["Woodfall Temple Main Ledge"] = {
        ...
        ["exits"] = {
            ["Woodfall Temple Main"] = function () return true end,
            ["Woodfall Temple Pits Room"] = function () return true end,
            ["Woodfall Temple Pre-Boss"] = function () return has_arrows() or can_use_din() end,
    ...
    ["Woodfall Temple Boss"] = {
        ["events"] = {
            ["BOSS_ODOLWA"] = function () return soul_boss(SOUL_BOSS_ODOLWA) and (has('MASK_FIERCE_DEITY') and has_magic() or (has_arrows() and can_fight())) end,
        },
        ["exits"] = {
